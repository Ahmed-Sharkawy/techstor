...
$products = $productObject->selectId($id, "products.name AS prodName, cats.name AS catsName, `price`, `piecec_no`, `img`, `desc`, cats_id");
  ...
  <div class="col-md-6 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <form action="<?= URL . "admin/handlers/handlers_edit_product.php" ?>" method="POST" class="forms-sample" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="category" id="exampleInputSselect">
              <?php foreach ($cats as $value) : ?>
                <option value="<?= $value['id'] ?>" <?php if ($value['id'] == $products['cats_id']) { echo 'selected'; } ?> ><?= $value['name'] ?></option>
              <?php endforeach; ?>
            </select>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" name="pieces" value="<?= $products['piecec_no'] ?>" class=" form-control" id="exampleInputPieces" placeholder="Pieces">
          </div>
          <div class="form-group">
          ...
          <a href="<?= URL . "admin/index.php" ?>" class="btn btn-light">Cancel</a>
        </form>
      </div>
    </div>
  </div>
