        ...
        <div class="row">
          <div class="col-md-12">
            <div class="d-sm-flex align-items-baseline report-summary-header">
              <h5 class="font-weight-semibold">Report Summary</h5> <span class="ml-auto">Updated Report</span> <a href="<?= URL . "admin/index.php" ?>" class="btn btn-icons border-0 p-2"><i class="icon-refresh"></i></a>
            </div>
          </div>
        </div>
    ...
    <div class="card">
      <div class="card-body">
        <div class="d-sm-flex align-items-center mb-4">
          ...
          <a href="<?= URL . "admin/product.php" ?>" class="text-dark ml-auto mb-3 mb-sm-0"> View all Products</a>
        </div>
