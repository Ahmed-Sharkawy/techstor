...
<head>
  ...
  <!-- endinject -->
  <!-- Layout styles -->
  <link rel="stylesheet" href="<?= URL ?>admin/assets/css/style.css" /> <!-- End layout styles -->
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
              <div class="brand-logo">
                <img src="<?= URL ?>admin/assets/images/logo.svg">
              </div>
              <h4>Hello! let's get started</h4>
              <h6 class="font-weight-light">Loge in to continue.</h6>
              <?php include "inc/errors.php" ?>
              <?php include "inc/success.php" ?>
              <form action="<?= URL ?>admin/handlers/handlers_login.php" method="POST" class="pt-3">
                ...
                <div class="mb-2">
                  <button type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn">LOGE IN</button>
                </div>
              </form>
            </div>
          </div>
