  ...
  <div class="col-md-6 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  <tr>
                    ...
                    <?php if ($order['status'] === "pending") :  ?>
                      <td>
                        <a href="<?= URL . "admin/handlers/handlers_approved.php?id=" . $order['id'] ?>" class="btn btn-success btn-sm">Approve</a>
                        <a href="<?= URL . "admin/handlers/handlers_cancel.php?id=" . $order['id'] ?>" class="btn btn-danger btn-sm">Cancel</a>
                      </td>
                    <?php endif; ?>
                  </tr>
                </tbody>
        ...
        <a href="<?= URL . "admin/orders.php" ?>" class="btn btn-dark btn-md">Back</a>
